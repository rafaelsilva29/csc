...
# Files
file = '../datasets/v1.0/AvenidaAliados.csv'
#file = '../datasets/v2.0/AvenidaGustavoEiffel.csv'
#file = '../datasets/v2.0/RuaCondeVizela.csv'
#file = '../datasets/v2.0/RuaNovaAlfandega.csv'
